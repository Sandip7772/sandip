...
$blockStyles = <<<BLOCK_CSS
    ...
    #{$blockId} .review-heading-wrapper .review-heading{
        ...
        color: {$attributes['headingOptions']['color']};
    }
    #{$blockId} .review-heading-wrapper .total-avg-rating-wrapper {
        background-color: {$attributes['headingOptions']['iconBgColor']};
    }
...
if ( $attributes['headingOptions']['enabled'] ) {
	...
	echo '<div class="display-inline-block total-avg-rating-wrapper" style="margin-right: 10px; padding: 0 10px; border-radius: 10px;">';
