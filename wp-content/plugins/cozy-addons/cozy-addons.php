 ...
 * Description:       Cozy Blocks - Page Builder for FSE & Gutenberg Editor, Gutenberg Blocks, WooCommerce Blocks, Post Blocks, Slider Blocks, Magazine Blocks, Elementor Widgets & Layouts.
 * Version:           1.3.13
 * Author:            CozyThemes
		...
		if ( ! isset( $cc_fs ) ) {
			...
			$cc_fs = fs_dynamic_init(
				array(
					...
					'is_premium'          => $paid_status,
					'premium_suffix'      => 'Pro',
					// If your plugin is a serviceware, set this option to false.
					'has_premium_version' => $paid_status,
					'has_addons'          => false,
...
define( 'COZY_ADDONS_VERSION', '1.3.13' );
